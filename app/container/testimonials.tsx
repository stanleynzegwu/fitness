...
const Testimonial = () => {
  return (
    <section className="relative px-8 pb-8 min-h-screen h-screen flex flex-col-reverse max-md:items-center md:flex-row gap-16 bg-gradient-to-br from-[#F7FDFF] to-[#FFF2F9] pt-16">
